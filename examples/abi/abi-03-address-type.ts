 ...
 * ### Run the example
 * ```bash
 * npx tsx examples/abi/abi-03-address-type.ts
 * ```
 *
 * {@includeCode ./abi-03-address-type.ts}
 */
function main() {
  ...
  const rawPublicKey = new Uint8Array([
    0xab, 0xcd, 0xef, 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef, 0x01, 0x23, 0x45,
...
export { main as ABIAddressTypeExample }