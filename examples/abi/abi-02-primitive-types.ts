...
import { ABIBoolType, ABIByteType, ABIUintType } from '@algorandfoundation/algokit-abi'
 ...
 * ### Run the example
 * ```bash
 * npx tsx examples/abi/abi-02-primitive-types.ts
 * ```
 *
 * {@includeCode ./abi-02-primitive-types.ts}
 */
function main() {
...
export { main as ABIPrimitiveTypesExample }