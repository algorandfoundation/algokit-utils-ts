 ...
 * ### Run the example
 * ```bash
 * npx tsx examples/algod_client/algod_client-18-devmode-timestamp.ts
 * ```
 *
 * {@includeCode ./algod_client-18-devmode-timestamp.ts}
 */
async function main() {
...
export { main as AlgodClientDevModeTimestampExample }