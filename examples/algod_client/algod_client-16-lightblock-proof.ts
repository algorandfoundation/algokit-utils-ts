 ...
 * ### Run the example
 * ```bash
 * npx tsx examples/algod_client/algod_client-16-lightblock-proof.ts
 * ```
 *
 * {@includeCode ./algod_client-16-lightblock-proof.ts}
 */
async function main() {
...
export { main as AlgodClientLightBlockProofExample }