 ...
 * ### Run the example
 * ```bash
 * npx tsx examples/algod_client/algod_client-10-application-info.ts
 * ```
 *
 * {@includeCode ./algod_client-10-application-info.ts}
 */
async function main() {
...
export { main as AlgodClientApplicationInfoExample }