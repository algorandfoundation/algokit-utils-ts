 ...
 * ### Run the example
 * ```bash
 * npx tsx examples/algod_client/algod_client-11-application-boxes.ts
 * ```
 *
 * {@includeCode ./algod_client-11-application-boxes.ts}
 */
async function main() {
...
export { main as AlgodClientApplicationBoxesExample }