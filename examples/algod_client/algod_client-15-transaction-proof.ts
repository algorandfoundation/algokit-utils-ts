 ...
 * ### Run the example
 * ```bash
 * npx tsx examples/algod_client/algod_client-15-transaction-proof.ts
 * ```
 *
 * {@includeCode ./algod_client-15-transaction-proof.ts}
 */
async function main() {
...
export { main as AlgodClientTransactionProofExample }