...
The [`AssetManager`](../../api/types/asset-manager/classes/AssetManager.md) is a class that is used to manage asset information.
...
The base type for specifying an asset creation transaction is [`AssetCreateParams`](../../api/types/composer/type-aliases/AssetCreateParams.md), which has the following parameters in addition to the [common transaction parameters](./algorand-client.md#transaction-parameters):
...
The base type for specifying an asset creation transaction is [`AssetConfigParams`](../../api/types/composer/type-aliases/AssetConfigParams.md), which has the following parameters in addition to the [common transaction parameters](./algorand-client.md#transaction-parameters):
...
The base type for specifying an asset transfer transaction is [`AssetTransferParams`](../../api/types/composer/type-aliases/AssetTransferParams.md), which has the following parameters in addition to the [common transaction parameters](./algorand-client.md#transaction-parameters):
...
The base type for specifying an asset opt-in transaction is [`AssetOptInParams`](../../api/types/composer/type-aliases/AssetOptInParams.md), which has the following parameters in addition to the [common transaction parameters](./algorand-client.md#transaction-parameters):
...
The base type for specifying an asset opt-out transaction is [`AssetOptOutParams`](../../api/types/composer/type-aliases/AssetOptOutParams.md), which has the following parameters in addition to the [common transaction parameters](./algorand-client.md#transaction-parameters):
...
The [`asset.bulkOptIn`](../../api/types/asset-manager/classes/AssetManager.md#bulkoptin) function facilitates the opt-in process for an account to multiple assets, allowing the account to receive and hold those assets.
...
The [`asset.bulkOptOut`](../../api/types/asset-manager/classes/AssetManager.md#bulkoptout) function facilitates the opt-out process for an account from multiple assets, permitting the account to discontinue holding a group of assets.
