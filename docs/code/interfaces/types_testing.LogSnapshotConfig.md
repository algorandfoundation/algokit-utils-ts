...
• `Optional` **accounts**: (`string` \| `Address` \| `MultisigAccount` \| `AddressWithTransactionSigner` \| `LogicSigAccount` \| `default` \| [`SigningAccount`](../classes/types_account.SigningAccount.md))[]
