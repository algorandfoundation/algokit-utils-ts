...
• **generateAccount**: (`params`: [`GetTestAccountParams`](types_testing.GetTestAccountParams.md)) => `Promise`\<[`Address`](../classes/index.Address.md) & `default` & `AddressWithSigner`\>

Generate and fund an additional ephemerally created account

#### Type declaration

▸ (`params`): `Promise`\<[`Address`](../classes/index.Address.md) & `default` & `AddressWithSigner`\>
...
`Promise`\<[`Address`](../classes/index.Address.md) & `default` & `AddressWithSigner`\>
...
• **testAccount**: [`Address`](../classes/index.Address.md) & `AddressWithSigner` & `default`
