...
| Name | Type | Description |
| :------ | :------ | :------ |
| `creator` | [`ReadableAddress`](../modules/index.md#readableaddress) | The address of the account that is the creator of the apps you want to search for |
