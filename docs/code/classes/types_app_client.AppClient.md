...
[src/types/app-client.ts:403](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L403)
...
[src/types/app-client.ts:410](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L410)
...
[src/types/app-client.ts:678](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L678)
...
[src/types/app-client.ts:575](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L575)
...
[src/types/app-client.ts:1176](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L1176)
...
[src/types/app-client.ts:1164](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L1164)
...
| `delete` | (`params`: \{ `accountReferences?`: `string`[] ; `appReferences?`: `bigint`[] ; `args?`: (`undefined` \| `ABIValue` \| [`AppMethodCallTransactionArgument`](../modules/types_composer.md#appmethodcalltransactionargument) \| [`ABIStruct`](../modules/types_app_arc56.md#abistruct))[] ; `assetReferences?`: `bigint`[] ; `boxReferences?`: ([`BoxIdentifier`](../modules/types_app_manager.md#boxidentifier) \| [`BoxReference`](../interfaces/types_app_manager.BoxReference.md))[] ; `extraFee?`: [`AlgoAmount`](types_amount.AlgoAmount.md) ; `firstValidRound?`: `bigint` ; `lastValidRound?`: `bigint` ; `lease?`: `string` \| `Uint8Array` ; `maxFee?`: [`AlgoAmount`](types_amount.AlgoAmount.md) ; `method`: `string` ; `note?`: `string` \| `Uint8Array` ; `onComplete?`: `OnApplicationComplete` ; `rekeyTo?`: `string` ; `returnValueFormatter?`: (`value`: `undefined` \| [`ABIReturn`](../modules/types_app.md#abireturn)) => `any` ; `sender?`: `string` ; `signer?`: `TransactionSigner` \| [`TransactionSignerAccount`](../interfaces/types_account.TransactionSignerAccount.md) ; `staticFee?`: [`AlgoAmount`](types_amount.AlgoAmount.md) ; `validityWindow?`: `number`  }) => [`AppDeleteMethodCall`](../modules/types_composer.md#appdeletemethodcall) | - |
...
[src/types/app-client.ts:963](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L963)
...
[src/types/app-client.ts:1002](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L1002)
...
[src/types/app-client.ts:1094](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L1094)
...
[src/types/app-client.ts:1273](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L1273)
...
[src/types/app-client.ts:1193](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L1193)
...
▸ **parseMethodCallReturn**\<`TReturn`, `TResult`\>(`result`, `method`, `returnValueFormatter?`): `Promise`\<[`Expand`](../modules/types_expand.md#expand)\<`Omit`\<`TResult`, ``"return"``\> & [`AppReturn`](../modules/types_app.md#appreturn)\<`TReturn`\>\>\>
...
| `returnValueFormatter?` | (`value`: `undefined` \| [`ABIReturn`](../modules/types_app.md#abireturn)) => `TReturn` | An optional function to format the return value and override default semantics |
...
[src/types/app-client.ts:465](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-client.ts#L465)
