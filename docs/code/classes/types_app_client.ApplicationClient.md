...
• `Private` **sender**: `undefined` \| `AddressWithTransactionSigner`
...
| `sender` | `AddressWithTransactionSigner` | The sender of this call. Will be used to fetch any default argument values if applicable |
...
| Name | Type |
| :------ | :------ |
| `account` | `string` \| `AddressWithTransactionSigner` |
