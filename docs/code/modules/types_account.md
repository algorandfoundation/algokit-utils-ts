...
[src/types/account.ts:216](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/account.ts#L216)
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `address` | [`Address`](../classes/index.Address.md) | The account public key |
...
| `authAddr?` | [`Address`](../classes/index.Address.md) | The address against which signing should be checked. If empty, the address of the current account is used. This field can be updated in any transaction by setting the `RekeyTo` field. |
...
[src/types/account.ts:64](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/account.ts#L64)
