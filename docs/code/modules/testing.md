...
▸ **getTestAccount**(`params`, `algod`, `kmd?`): `Promise`\<[`Address`](../classes/index.Address.md) & `Account` & `AddressWithSigner`\>
...
`Promise`\<[`Address`](../classes/index.Address.md) & `Account` & `AddressWithSigner`\>
...
▸ **getTestAccount**(`params`, `algorand`): `Promise`\<[`Address`](../classes/index.Address.md) & `Account` & `AddressWithSigner`\>
...
[src/testing/account.ts:36](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/testing/account.ts#L36)
