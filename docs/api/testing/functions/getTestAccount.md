...
[@algorandfoundation/algokit-utils](../../modules.md) / [testing](../README.md) / getTestAccount

# Function: getTestAccount()

## Call Signature

> **getTestAccount**(`params`, `algod`, `kmd?`): `Promise`\<[`Address`](../../index/classes/Address.md) & [`AddressWithTransactionSigner`](../../transact/interfaces/AddressWithTransactionSigner.md)\>
...
`Promise`\<[`Address`](../../index/classes/Address.md) & [`AddressWithTransactionSigner`](../../transact/interfaces/AddressWithTransactionSigner.md)\>
...
> **getTestAccount**(`params`, `algorand`): `Promise`\<[`Address`](../../index/classes/Address.md) & `object`\>
