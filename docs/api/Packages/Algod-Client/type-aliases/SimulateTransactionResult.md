...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Algod Client](../README.md) / SimulateTransactionResult
...
> `optional` **fixedSigner**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
