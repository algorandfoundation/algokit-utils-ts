...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Algod Client](../README.md) / BlockAppEvalDelta
...
> `optional` **sharedAccounts**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)[]
