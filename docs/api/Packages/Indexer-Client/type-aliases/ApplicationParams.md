...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Indexer Client](../README.md) / ApplicationParams
...
> `optional` **creator**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
