...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Transact](../README.md) / TransactionParams
...
> `optional` **rekeyTo**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
...
> **sender**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
