...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Transact](../README.md) / AssetTransferTransactionFields
...
> `optional` **assetSender**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
...
> `optional` **closeRemainderTo**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
...
> **receiver**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
