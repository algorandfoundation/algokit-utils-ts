...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Transact](../README.md) / SignedTransaction
...
> `optional` **authAddress**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
