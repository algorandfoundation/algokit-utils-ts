...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Transact](../README.md) / LogicSig
...
> `protected` **\_addr**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
...
> **get** **addr**(): [`Address`](../../../Algokit-Utils-API/classes/Address.md)
...
[`Addressable`](../../../Algokit-Utils-API/interfaces/Addressable.md).[`addr`](../../../Algokit-Utils-API/interfaces/Addressable.md#addr)
