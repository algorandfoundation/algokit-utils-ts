...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Transact](../README.md) / MultisigAccount
...
> **\_addr**: [`Address`](../../../Algokit-Utils-API/classes/Address.md)
...
> **get** **addr**(): `Readonly`\<[`Address`](../../../Algokit-Utils-API/classes/Address.md)\>
...
`Readonly`\<[`Address`](../../../Algokit-Utils-API/classes/Address.md)\>
