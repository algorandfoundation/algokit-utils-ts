...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/Testing](../README.md) / getTestAccount

# Function: getTestAccount()

## Call Signature

> **getTestAccount**(`params`, `algod`, `kmd?`): `Promise`\<[`Address`](../../../Algokit-Utils-API/classes/Address.md) & [`AddressWithTransactionSigner`](../../Transact/interfaces/AddressWithTransactionSigner.md)\>
...
`Promise`\<[`Address`](../../../Algokit-Utils-API/classes/Address.md) & [`AddressWithTransactionSigner`](../../Transact/interfaces/AddressWithTransactionSigner.md)\>
...
> **getTestAccount**(`params`, `algorand`): `Promise`\<[`Address`](../../../Algokit-Utils-API/classes/Address.md) & `object`\>
