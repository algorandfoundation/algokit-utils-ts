...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Packages/KMD Client](../README.md) / KmdApi

# Class: KmdApi

Defined in: [packages/kmd\_client/src/apis/api-service.ts:89](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/packages/kmd_client/src/apis/api-service.ts#L89)
