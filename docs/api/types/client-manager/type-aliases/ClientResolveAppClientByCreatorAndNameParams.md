...
[@algorandfoundation/algokit-utils](../../../modules.md) / [types/client-manager](../README.md) / ClientResolveAppClientByCreatorAndNameParams
...
Defined in: [src/types/client-manager.ts:26](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/client-manager.ts#L26)
