...
> **ABIAppCallArg** = [`ABIValue`](../../../abi/type-aliases/ABIValue.md) \| [`TransactionWithSigner`](../../../index/interfaces/TransactionWithSigner.md) \| [`TransactionToSign`](../../transaction/interfaces/TransactionToSign.md) \| [`Transaction`](../../../transact/classes/Transaction.md) \| `Promise`\<[`SendTransactionResult`](../../transaction/interfaces/SendTransactionResult.md)\> \| [`SendTransactionResult`](../../transaction/interfaces/SendTransactionResult.md) \| `undefined`
