...
[@algorandfoundation/algokit-utils](../../../modules.md) / [types/app](../README.md) / APP\_DEPLOY\_NOTE\_DAPP

# Variable: APP\_DEPLOY\_NOTE\_DAPP

> `const` **APP\_DEPLOY\_NOTE\_DAPP**: `"ALGOKIT_DEPLOYER"` = `'ALGOKIT_DEPLOYER'`

Defined in: [src/types/app.ts:25](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app.ts#L25)
