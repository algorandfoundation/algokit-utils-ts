...
> **appAddress**: [`Address`](../../../index/classes/Address.md)
...
> **creator**: [`Address`](../../../index/classes/Address.md)
...
Defined in: [src/types/app-manager.ts:49](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/app-manager.ts#L49)
