...
Defined in: [src/types/testing.ts:21](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/testing.ts#L21)
...
Defined in: [src/types/testing.ts:23](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/testing.ts#L23)
...
> **generateAccount**: (`params`) => `Promise`\<[`Address`](../../../index/classes/Address.md) & `object`\>
...
> **testAccount**: [`Address`](../../../index/classes/Address.md) & `object`
...
> **addr**: `Readonly`\<[`Address`](../../../index/classes/Address.md)\>
...
Defined in: [src/types/testing.ts:37](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/testing.ts#L37)
