...
[@algorandfoundation/algokit-utils](../../../modules.md) / [types/network-client](../README.md) / NetworkDetails

# Interface: NetworkDetails

Defined in: [src/types/network-client.ts:22](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/network-client.ts#L22)
