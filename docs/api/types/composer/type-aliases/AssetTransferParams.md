...
> `optional` **clawbackTarget**: [`ReadableAddress`](../../../index/type-aliases/ReadableAddress.md)
...
> `optional` **closeAssetTo**: [`ReadableAddress`](../../../index/type-aliases/ReadableAddress.md)
