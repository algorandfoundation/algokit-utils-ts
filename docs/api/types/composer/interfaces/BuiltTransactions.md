...
Defined in: [src/types/composer.ts:214](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/types/composer.ts#L214)
...
> **methodCalls**: `Map`\<`number`, [`ABIMethod`](../../../abi/classes/ABIMethod.md)\>
...
> **signers**: `Map`\<`number`, [`TransactionSigner`](../../../transact/type-aliases/TransactionSigner.md)\>
