...
To see some usage examples check out the [automated tests](../../_media/amount.ts). Alternatively, you see the [reference documentation](../../_media/AlgoAmount.md) for `AlgoAmount`.
