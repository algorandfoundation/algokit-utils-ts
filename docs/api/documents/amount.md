...
[@algorandfoundation/algokit-utils](../modules.md) / amount
...
To see some usage examples check out the [automated tests](../_media/amount.spec.ts). Alternatively, you see the [reference documentation](.../api/classes/types_amount.AlgoAmount.md) for `AlgoAmount`.
