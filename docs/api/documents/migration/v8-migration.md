...
[@algorandfoundation/algokit-utils](../../modules.md) / migration/v8-migration
...
Using the context gathered from Step 1, you should have all the information you need to migrate using the [version 7 migration guide](v7-migration.md).
