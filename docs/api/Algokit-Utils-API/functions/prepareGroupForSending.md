...
[@algorandfoundation/algokit-utils](../../modules.md) / [Algokit Utils API](../README.md) / prepareGroupForSending
...
Defined in: [src/transaction/transaction.ts:95](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/transaction/transaction.ts#L95)
