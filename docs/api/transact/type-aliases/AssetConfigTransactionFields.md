...
[@algorandfoundation/algokit-utils](../../modules.md) / [transact](../README.md) / AssetConfigTransactionFields
...
> `optional` **clawback**: [`Address`](../../index/classes/Address.md)
...
> `optional` **freeze**: [`Address`](../../index/classes/Address.md)
...
> `optional` **manager**: [`Address`](../../index/classes/Address.md)
...
> `optional` **reserve**: [`Address`](../../index/classes/Address.md)
