...
[@algorandfoundation/algokit-utils](../../modules.md) / [transact](../README.md) / MultisigAccount
...
> **\_addr**: [`Address`](../../index/classes/Address.md)
...
> **get** **addr**(): `Readonly`\<[`Address`](../../index/classes/Address.md)\>
...
`Readonly`\<[`Address`](../../index/classes/Address.md)\>
