...
[@algorandfoundation/algokit-utils](../../modules.md) / [algokit-utils](../README.md) / AccountManager

# Class: AccountManager

Defined in: [src/account-manager.ts:48](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L48)

Creates and keeps track of signing accounts that can sign transactions for a sending address.

## See

 - [KmdAccountManager](KmdAccountManager.md) for KMD-specific account management
...
Defined in: [src/account-manager.ts:63](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L63)
...
> **get** **kmd**(): [`KmdAccountManager`](KmdAccountManager.md)

Defined in: [src/account-manager.ts:85](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L85)
...
[`KmdAccountManager`](KmdAccountManager.md)
...
Defined in: [src/account-manager.ts:474](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L474)
...
Defined in: [src/account-manager.ts:594](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L594)
...
`object` & [`SendParams`](../interfaces/SendParams.md) & `Omit`\<`CommonTransactionParams`, `"sender"`\>
...
Defined in: [src/account-manager.ts:656](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L656)
...
Defined in: [src/account-manager.ts:712](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L712)
...
Defined in: [src/account-manager.ts:347](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L347)
...
> **fromKmd**(`name`, `predicate?`, `sender?`): `Promise`\<[`Address`](Address.md) & [`AddressWithTransactionSigner`](../../Subpaths/transact/interfaces/AddressWithTransactionSigner.md) & `object`\>

Defined in: [src/account-manager.ts:382](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L382)
...
`Promise`\<[`Address`](Address.md) & [`AddressWithTransactionSigner`](../../Subpaths/transact/interfaces/AddressWithTransactionSigner.md) & `object`\>
...
Defined in: [src/account-manager.ts:290](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L290)
...
Defined in: [src/account-manager.ts:225](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L225)
...
> **getInformation**(`sender`): `Promise`\<[`AccountInformation`](../type-aliases/AccountInformation.md)\>

Defined in: [src/account-manager.ts:244](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L244)
...
Defined in: [src/account-manager.ts:205](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L205)
...
> **localNetDispenser**(): `Promise`\<[`Address`](Address.md) & [`AddressWithTransactionSigner`](../../Subpaths/transact/interfaces/AddressWithTransactionSigner.md) & `object`\>

Defined in: [src/account-manager.ts:493](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L493)
...
> **logicsig**(`program`, `args?`): [`Address`](Address.md) & [`AddressWithTransactionSigner`](../../Subpaths/transact/interfaces/AddressWithTransactionSigner.md) & `object`

Defined in: [src/account-manager.ts:420](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L420)
...
[`Address`](Address.md) & [`AddressWithTransactionSigner`](../../Subpaths/transact/interfaces/AddressWithTransactionSigner.md) & `object`
...
> **multisig**(`multisigParams`, `subSigners`): [`Address`](Address.md) & [`AddressWithTransactionSigner`](../../Subpaths/transact/interfaces/AddressWithTransactionSigner.md) & `object`

Defined in: [src/account-manager.ts:405](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L405)
...
> **random**(): [`Address`](Address.md) & `object`

Defined in: [src/account-manager.ts:433](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L433)
...
Defined in: [src/account-manager.ts:536](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L536)
...
`string` | [`Address`](Address.md) | [`AddressWithTransactionSigner`](../../Subpaths/transact/interfaces/AddressWithTransactionSigner.md)
...
> **rekeyed**(`sender`, `account`): [`Address`](Address.md) & [`AddressWithTransactionSigner`](../../Subpaths/transact/interfaces/AddressWithTransactionSigner.md) & `object`

Defined in: [src/account-manager.ts:316](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L316)
...
Defined in: [src/account-manager.ts:105](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L105)
...
Defined in: [src/account-manager.ts:168](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L168)
...
Defined in: [src/account-manager.ts:152](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L152)
...
Defined in: [src/account-manager.ts:185](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/account-manager.ts#L185)
