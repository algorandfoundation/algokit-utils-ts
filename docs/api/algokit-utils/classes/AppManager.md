...
[@algorandfoundation/algokit-utils](../../modules.md) / [algokit-utils](../README.md) / AppManager

# Class: AppManager

Defined in: [src/app-manager.ts:100](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L100)
...
Defined in: [src/app-manager.ts:108](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L108)
...
> **compileTeal**(`tealCode`): `Promise`\<[`CompiledTeal`](../interfaces/CompiledTeal.md)\>

Defined in: [src/app-manager.ts:127](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L127)
...
`Promise`\<[`CompiledTeal`](../interfaces/CompiledTeal.md)\>
...
> **compileTealTemplate**(`tealTemplateCode`, `templateParams?`, `deploymentMetadata?`): `Promise`\<[`CompiledTeal`](../interfaces/CompiledTeal.md)\>

Defined in: [src/app-manager.ts:163](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L163)
...
> **getBoxNames**(`appId`): `Promise`\<[`BoxName`](../interfaces/BoxName.md)[]\>

Defined in: [src/app-manager.ts:275](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L275)
...
[`BoxIdentifier`](../type-aliases/BoxIdentifier.md) | [`BoxName`](../interfaces/BoxName.md)
...
> **getBoxValueFromABIType**(`request`): `Promise`\<[`ABIValue`](../../Subpaths/abi/type-aliases/ABIValue.md)\>

Defined in: [src/app-manager.ts:322](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L322)
...
> **getBoxValuesFromABIType**(`request`): `Promise`\<[`ABIValue`](../../Subpaths/abi/type-aliases/ABIValue.md)[]\>

Defined in: [src/app-manager.ts:337](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L337)
...
Defined in: [src/app-manager.ts:204](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L204)
...
> **getCompilationResult**(`tealCode`): [`CompiledTeal`](../interfaces/CompiledTeal.md) \| `undefined`

Defined in: [src/app-manager.ts:189](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L189)
...
[`CompiledTeal`](../interfaces/CompiledTeal.md) \| `undefined`
...
> **getGlobalState**(`appId`): `Promise`\<[`AppState`](../interfaces/AppState.md)\>

Defined in: [src/app-manager.ts:234](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L234)
...
> **getLocalState**(`appId`, `address`): `Promise`\<[`AppState`](../interfaces/AppState.md)\>

Defined in: [src/app-manager.ts:249](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L249)
...
> `static` **decodeAppState**(`state`): [`AppState`](../interfaces/AppState.md)

Defined in: [src/app-manager.ts:369](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L369)
...
> `static` **getABIReturn**(`confirmation`, `method`): [`ABIReturn`](../../Subpaths/abi/type-aliases/ABIReturn.md) \| `undefined`

Defined in: [src/app-manager.ts:418](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L418)
...
[`PendingTransactionResponse`](../../Subpaths/algod-client/type-aliases/PendingTransactionResponse.md) | `undefined`

##### method

The ABI method

[`ABIMethod`](../../Subpaths/abi/classes/ABIMethod.md) | `undefined`

#### Returns

[`ABIReturn`](../../Subpaths/abi/type-aliases/ABIReturn.md) \| `undefined`
...
> `static` **getBoxReference**(`boxId`): [`BoxReference`](../../Subpaths/transact/type-aliases/BoxReference.md)

Defined in: [src/app-manager.ts:351](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L351)
...
[`BoxReference`](../../Subpaths/transact/type-aliases/BoxReference.md)
...
Defined in: [src/app-manager.ts:473](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L473)
...
Defined in: [src/app-manager.ts:508](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L508)
...
Defined in: [src/app-manager.ts:547](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/app-manager.ts#L547)
