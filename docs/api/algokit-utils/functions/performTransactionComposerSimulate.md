...
Defined in: [src/transaction/perform-transaction-composer-simulate.ts:14](https://github.com/p2arthur/algokit-utils-ts-fork/blob/main/src/transaction/perform-transaction-composer-simulate.ts#L14)
