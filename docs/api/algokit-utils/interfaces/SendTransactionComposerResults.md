...
Defined in: [src/transaction/types.ts:77](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/transaction/types.ts#L77)
...
Defined in: [src/transaction/types.ts:69](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/transaction/types.ts#L69)
...
Defined in: [src/transaction/types.ts:73](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/transaction/types.ts#L73)
...
Defined in: [src/transaction/types.ts:71](https://github.com/algorandfoundation/algokit-utils-ts/blob/main/src/transaction/types.ts#L71)
