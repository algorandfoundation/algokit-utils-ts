...
[@algorandfoundation/algokit-utils](../../modules.md) / [index](../README.md) / performTransactionComposerSimulate

# ~~Function: performTransactionComposerSimulate()~~

> **performTransactionComposerSimulate**(`composer`, `options?`): `Promise`\<[`SimulateResponse`](../../algod-client/type-aliases/SimulateResponse.md)\>
...
`Promise`\<[`SimulateResponse`](../../algod-client/type-aliases/SimulateResponse.md)\>
