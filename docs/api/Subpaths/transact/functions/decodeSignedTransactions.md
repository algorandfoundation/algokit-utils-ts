...
Defined in: [packages/transact/src/transactions/signed-transaction.ts:149](https://github.com/p2arthur/algokit-utils-ts-fork/blob/main/packages/transact/src/transactions/signed-transaction.ts#L149)
