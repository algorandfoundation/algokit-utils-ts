...
Defined in: [packages/transact/src/transactions/signed-transaction.ts:115](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/packages/transact/src/transactions/signed-transaction.ts#L115)
