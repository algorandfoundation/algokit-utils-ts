...
Defined in: [packages/transact/src/transactions/transaction.ts:391](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/packages/transact/src/transactions/transaction.ts#L391)
