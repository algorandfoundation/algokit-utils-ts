...
Defined in: [packages/indexer\_client/src/apis/api-service.ts:43](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/packages/indexer_client/src/apis/api-service.ts#L43)
