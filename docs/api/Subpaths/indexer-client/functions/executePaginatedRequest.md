...
Defined in: [src/indexer-client/indexer-lookup.ts:120](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/indexer-client/indexer-lookup.ts#L120)
