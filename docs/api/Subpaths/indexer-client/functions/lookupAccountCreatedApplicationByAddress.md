...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Subpaths/indexer-client](../README.md) / lookupAccountCreatedApplicationByAddress
...
Defined in: [src/indexer-client/indexer-lookup.ts:23](https://github.com/p2arthur/algokit-utils-ts-fork/blob/main/src/indexer-client/indexer-lookup.ts#L23)
