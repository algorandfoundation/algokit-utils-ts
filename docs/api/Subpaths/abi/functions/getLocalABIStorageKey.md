...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Subpaths/abi](../README.md) / getLocalABIStorageKey

# Function: getLocalABIStorageKey()

> **getLocalABIStorageKey**(`contract`, `keyName`): [`ABIStorageKey`](../type-aliases/ABIStorageKey.md)

Defined in: [packages/abi/src/arc56-contract.ts:395](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/packages/abi/src/arc56-contract.ts#L395)
