...
Defined in: [packages/kmd\_client/src/apis/api-service.ts:89](https://github.com/p2arthur/algokit-utils-ts-fork/blob/main/packages/kmd_client/src/apis/api-service.ts#L89)
