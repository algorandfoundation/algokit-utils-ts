...
Defined in: [packages/kmd\_client/src/core/fetch-http-request.ts:61](https://github.com/p2arthur/algokit-utils-ts-fork/blob/main/packages/kmd_client/src/core/fetch-http-request.ts#L61)
...
Defined in: [packages/kmd\_client/src/core/fetch-http-request.ts:62](https://github.com/p2arthur/algokit-utils-ts-fork/blob/main/packages/kmd_client/src/core/fetch-http-request.ts#L62)
