...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Subpaths/testing](../README.md) / getTestAccount
...
Defined in: [src/testing/account.ts:20](https://github.com/p2arthur/algokit-utils-ts-fork/blob/main/src/testing/account.ts#L20)
...
`Promise`\<[`Address`](../../../algokit-utils/classes/Address.md) & [`AddressWithTransactionSigner`](../../transact/interfaces/AddressWithTransactionSigner.md)\>
...
Defined in: [src/testing/account.ts:34](https://github.com/p2arthur/algokit-utils-ts-fork/blob/main/src/testing/account.ts#L34)
