...
[@algorandfoundation/algokit-utils](../../../modules.md) / [Subpaths/testing](../README.md) / runWhenIndexerCaughtUp

# Function: runWhenIndexerCaughtUp()

> **runWhenIndexerCaughtUp**\<`T`\>(`run`): `Promise`\<`T`\>

Defined in: [src/testing/indexer.ts:12](https://github.com/algorandfoundation/algokit-utils-ts/blob/decoupling/src/testing/indexer.ts#L12)
