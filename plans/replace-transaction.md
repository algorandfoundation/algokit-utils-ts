...
```typescript
// BEFORE:
export function signLogicSigTransactionWithAddress(txn: Transaction, lsig: LogicSig, signerAddr: Address): SignedTransaction {
...
// AFTER:
export function signLogicSigTransactionWithAddress(txn: Transaction, lsig: LogicSig, signerAddr: string): SignedTransaction {
  return {
    transaction: txn,
    logicSignature: {
      logic: lsig.logic,
