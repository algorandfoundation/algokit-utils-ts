 ...
 */
export type Overwrite<T, U extends Partial<T>> = Pick<T, Exclude<keyof T, keyof U>> & U

/**
 * Same as Overwrite, but will distribute the Overwrite over unions
 */
export type DistributiveOverwrite<T, K extends Partial<T>> = T extends unknown ? Overwrite<T, K> : never
