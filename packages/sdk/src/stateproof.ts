...
export class MerkleArrayProof implements Encodable {
  ...
  public constructor(params: { path: Uint8Array[]; hashFactory: HashFactory; treeDepth: number }) {
...
export class FalconSignatureStruct implements Encodable {
  ...
  public constructor(params: { signature: Uint8Array; index: bigint; proof: MerkleArrayProof; verifyingKey: FalconVerifier }) {
...
export class Reveal implements Encodable {
  ...
  public constructor(params: { sigslot: SigslotCommit; participant: Participant }) {
...
export class StateProof implements Encodable {
  ...
  public toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['r', convertMap(this.reveals, (key, value) => [key, value.toEncodingData()])],
  ...
  public static fromEncodingData(data: unknown): StateProof {
    ...
    return new StateProof({
      ...
      reveals: convertMap(data.get('r'), (key, value) => [key as bigint, Reveal.fromEncodingData(value)]),
