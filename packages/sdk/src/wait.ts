import type { AlgodClient, PendingTransactionResponse } from '../../algod_client/src'
 ...
 */
export async function waitForConfirmation(client: AlgodClient, txid: string, waitRounds: number): Promise<PendingTransactionResponse> {
