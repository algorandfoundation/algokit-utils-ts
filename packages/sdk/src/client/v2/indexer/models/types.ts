...
export class Account implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['apps-local-state', typeof this.appsLocalState !== 'undefined' ? this.appsLocalState.map((v) => v.toEncodingData()) : undefined],
      ['apps-total-extra-pages', this.appsTotalExtraPages],
      ['apps-total-schema', typeof this.appsTotalSchema !== 'undefined' ? this.appsTotalSchema.toEncodingData() : undefined],
      ['assets', typeof this.assets !== 'undefined' ? this.assets.map((v) => v.toEncodingData()) : undefined],
      ['auth-addr', typeof this.authAddr !== 'undefined' ? this.authAddr.toString() : undefined],
      ['closed-at-round', this.closedAtRound],
      ['created-apps', typeof this.createdApps !== 'undefined' ? this.createdApps.map((v) => v.toEncodingData()) : undefined],
      ['created-assets', typeof this.createdAssets !== 'undefined' ? this.createdAssets.map((v) => v.toEncodingData()) : undefined],
      ...
      ['participation', typeof this.participation !== 'undefined' ? this.participation.toEncodingData() : undefined],
    ...
    return new Account({
      ...
      appsLocalState:
        typeof data.get('apps-local-state') !== 'undefined'
          ? data.get('apps-local-state').map((v: unknown) => ApplicationLocalState.fromEncodingData(v))
          : undefined,
      ...
      appsTotalSchema:
        typeof data.get('apps-total-schema') !== 'undefined'
          ...
          : undefined,
      assets:
        typeof data.get('assets') !== 'undefined' ? data.get('assets').map((v: unknown) => AssetHolding.fromEncodingData(v)) : undefined,
      authAddr: data.get('auth-addr'),
      closedAtRound: data.get('closed-at-round'),
      createdApps:
        typeof data.get('created-apps') !== 'undefined'
          ? data.get('created-apps').map((v: unknown) => Application.fromEncodingData(v))
          : undefined,
      createdAssets:
        typeof data.get('created-assets') !== 'undefined'
          ? data.get('created-assets').map((v: unknown) => Asset.fromEncodingData(v))
          : undefined,
      ...
      participation:
        typeof data.get('participation') !== 'undefined' ? AccountParticipation.fromEncodingData(data.get('participation')) : undefined,
...
export class AccountParticipation implements Encodable {
  ...
  constructor({
    ...
    this.selectionParticipationKey =
      typeof selectionParticipationKey === 'string' ? base64ToBytes(selectionParticipationKey) : selectionParticipationKey
...
export class AccountResponse implements Encodable {
   ...
   */
  constructor({ account, currentRound }: { account: Account; currentRound: number | bigint }) {
...
export class AccountStateDelta implements Encodable {
   ...
   */
  constructor({ address, delta }: { address: string; delta: EvalDeltaKeyValue[] }) {
    this.address = address
    this.delta = delta
  }
  ...
  static fromEncodingData(data: unknown): AccountStateDelta {
    ...
    return new AccountStateDelta({
      address: data.get('address'),
      delta: (data.get('delta') ?? []).map((v: unknown) => EvalDeltaKeyValue.fromEncodingData(v)),
    })
  }
}
...
export class AccountsResponse implements Encodable {
   ...
   * next parameter.
   */
  constructor({ accounts, currentRound, nextToken }: { accounts: Account[]; currentRound: number | bigint; nextToken?: string }) {
  ...
  static fromEncodingData(data: unknown): AccountsResponse {
    ...
    return new AccountsResponse({
      accounts: (data.get('accounts') ?? []).map((v: unknown) => Account.fromEncodingData(v)),
      currentRound: data.get('current-round'),
...
export class ApplicationLocalState implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['deleted', this.deleted],
      ['key-value', typeof this.keyValue !== 'undefined' ? this.keyValue.map((v) => v.toEncodingData()) : undefined],
    ...
    return new ApplicationLocalState({
      ...
      keyValue:
        typeof data.get('key-value') !== 'undefined'
          ? data.get('key-value').map((v: unknown) => TealKeyValue.fromEncodingData(v))
          : undefined,
...
export class ApplicationLocalStatesResponse implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['apps-local-states', this.appsLocalStates.map((v) => v.toEncodingData())],
      ['current-round', this.currentRound],
      ['next-token', this.nextToken],
    ])
  }
  ...
  static fromEncodingData(data: unknown): ApplicationLocalStatesResponse {
    ...
    return new ApplicationLocalStatesResponse({
      appsLocalStates: (data.get('apps-local-states') ?? []).map((v: unknown) => ApplicationLocalState.fromEncodingData(v)),
      currentRound: data.get('current-round'),
      nextToken: data.get('next-token'),
    })
  }
...
export class ApplicationLogsResponse implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['current-round', this.currentRound],
      ['log-data', typeof this.logData !== 'undefined' ? this.logData.map((v) => v.toEncodingData()) : undefined],
      ['next-token', this.nextToken],
    ])
  }
    ...
    return new ApplicationLogsResponse({
      ...
      logData:
        typeof data.get('log-data') !== 'undefined'
          ? data.get('log-data').map((v: unknown) => ApplicationLogData.fromEncodingData(v))
          : undefined,
      nextToken: data.get('next-token'),
    })
  }
...
export class ApplicationParams implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['creator', typeof this.creator !== 'undefined' ? this.creator.toString() : undefined],
      ['extra-program-pages', this.extraProgramPages],
      ['global-state', typeof this.globalState !== 'undefined' ? this.globalState.map((v) => v.toEncodingData()) : undefined],
      ['global-state-schema', typeof this.globalStateSchema !== 'undefined' ? this.globalStateSchema.toEncodingData() : undefined],
      ['local-state-schema', typeof this.localStateSchema !== 'undefined' ? this.localStateSchema.toEncodingData() : undefined],
    ...
    return new ApplicationParams({
      ...
      globalState:
        typeof data.get('global-state') !== 'undefined'
          ? data.get('global-state').map((v: unknown) => TealKeyValue.fromEncodingData(v))
          : undefined,
      globalStateSchema:
...
export class ApplicationResponse implements Encodable {
   ...
   */
  constructor({ currentRound, application }: { currentRound: number | bigint; application?: Application }) {
    this.currentRound = ensureBigInt(currentRound)
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['current-round', this.currentRound],
      ['application', typeof this.application !== 'undefined' ? this.application.toEncodingData() : undefined],
    ])
  }
...
export class ApplicationStateSchema implements Encodable {
   ...
   */
  constructor({ numByteSlice, numUint }: { numByteSlice: number | bigint; numUint: number | bigint }) {
...
export class ApplicationsResponse implements Encodable {
  ...
  static fromEncodingData(data: unknown): ApplicationsResponse {
    ...
    return new ApplicationsResponse({
      applications: (data.get('applications') ?? []).map((v: unknown) => Application.fromEncodingData(v)),
      currentRound: data.get('current-round'),
      nextToken: data.get('next-token'),
    })
  }
...
export class AssetBalancesResponse implements Encodable {
   ...
   * next parameter.
   */
  constructor({ balances, currentRound, nextToken }: { balances: MiniAssetHolding[]; currentRound: number | bigint; nextToken?: string }) {
  ...
  static fromEncodingData(data: unknown): AssetBalancesResponse {
    ...
    return new AssetBalancesResponse({
      balances: (data.get('balances') ?? []).map((v: unknown) => MiniAssetHolding.fromEncodingData(v)),
      currentRound: data.get('current-round'),
      nextToken: data.get('next-token'),
    })
  }
...
export class AssetHoldingsResponse implements Encodable {
   ...
   * next parameter.
   */
  constructor({ assets, currentRound, nextToken }: { assets: AssetHolding[]; currentRound: number | bigint; nextToken?: string }) {
    this.assets = assets
    this.currentRound = ensureBigInt(currentRound)
    this.nextToken = nextToken
  }
  ...
  static fromEncodingData(data: unknown): AssetHoldingsResponse {
    ...
    return new AssetHoldingsResponse({
      assets: (data.get('assets') ?? []).map((v: unknown) => AssetHolding.fromEncodingData(v)),
      currentRound: data.get('current-round'),
      nextToken: data.get('next-token'),
    })
  }
...
export class AssetResponse implements Encodable {
   ...
   * @param currentRound - Round at which the results were computed.
   */
  constructor({ asset, currentRound }: { asset: Asset; currentRound: number | bigint }) {
    this.asset = asset
    this.currentRound = ensureBigInt(currentRound)
  }
...
export class AssetsResponse implements Encodable {
   ...
   * next parameter.
   */
  constructor({ assets, currentRound, nextToken }: { assets: Asset[]; currentRound: number | bigint; nextToken?: string }) {
    this.assets = assets
    this.currentRound = ensureBigInt(currentRound)
    this.nextToken = nextToken
  }
  ...
  static fromEncodingData(data: unknown): AssetsResponse {
    ...
    return new AssetsResponse({
      assets: (data.get('assets') ?? []).map((v: unknown) => Asset.fromEncodingData(v)),
      currentRound: data.get('current-round'),
      nextToken: data.get('next-token'),
    })
  }
...
export class Block implements Encodable {
  ...
  constructor({
    ...
    this.transactionsRootSha256 =
      typeof transactionsRootSha256 === 'string' ? base64ToBytes(transactionsRootSha256) : transactionsRootSha256
    ...
    this.transactionsRootSha512 =
      typeof transactionsRootSha512 === 'string' ? base64ToBytes(transactionsRootSha512) : transactionsRootSha512
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['participation-updates', typeof this.participationUpdates !== 'undefined' ? this.participationUpdates.toEncodingData() : undefined],
      ['previous-block-hash-512', this.previousBlockHash512],
      ['proposer', typeof this.proposer !== 'undefined' ? this.proposer.toString() : undefined],
      ['proposer-payout', this.proposerPayout],
      ['rewards', typeof this.rewards !== 'undefined' ? this.rewards.toEncodingData() : undefined],
      [
        'state-proof-tracking',
        typeof this.stateProofTracking !== 'undefined' ? this.stateProofTracking.map((v) => v.toEncodingData()) : undefined,
      ],
      ['transactions', typeof this.transactions !== 'undefined' ? this.transactions.map((v) => v.toEncodingData()) : undefined],
      ['transactions-root-sha512', this.transactionsRootSha512],
      ['txn-counter', this.txnCounter],
      ['upgrade-state', typeof this.upgradeState !== 'undefined' ? this.upgradeState.toEncodingData() : undefined],
      ['upgrade-vote', typeof this.upgradeVote !== 'undefined' ? this.upgradeVote.toEncodingData() : undefined],
    ])
  }
    ...
    return new Block({
      ...
      stateProofTracking:
        typeof data.get('state-proof-tracking') !== 'undefined'
          ? data.get('state-proof-tracking').map((v: unknown) => StateProofTracking.fromEncodingData(v))
          : undefined,
      transactions:
        typeof data.get('transactions') !== 'undefined'
          ? data.get('transactions').map((v: unknown) => Transaction.fromEncodingData(v))
          : undefined,
      transactionsRootSha512: data.get('transactions-root-sha512'),
      txnCounter: data.get('txn-counter'),
      upgradeState:
        typeof data.get('upgrade-state') !== 'undefined' ? BlockUpgradeState.fromEncodingData(data.get('upgrade-state')) : undefined,
      upgradeVote:
        typeof data.get('upgrade-vote') !== 'undefined' ? BlockUpgradeVote.fromEncodingData(data.get('upgrade-vote')) : undefined,
    })
  }
}
...
export class BlockHeadersResponse implements Encodable {
   ...
   * next parameter.
   */
  constructor({ blocks, currentRound, nextToken }: { blocks: Block[]; currentRound: number | bigint; nextToken?: string }) {
    this.blocks = blocks
    this.currentRound = ensureBigInt(currentRound)
    this.nextToken = nextToken
  }
  ...
  static fromEncodingData(data: unknown): BlockHeadersResponse {
    ...
    return new BlockHeadersResponse({
      blocks: (data.get('blocks') ?? []).map((v: unknown) => Block.fromEncodingData(v)),
      currentRound: data.get('current-round'),
      nextToken: data.get('next-token'),
    })
  }
...
export class Box implements Encodable {
   ...
   */
  constructor({ name, round, value }: { name: string | Uint8Array; round: number | bigint; value: string | Uint8Array }) {
...
export class BoxReference implements Encodable {
   ...
   * @param name - Base64 encoded box name
   */
  constructor({ app, name }: { app: number | bigint; name: string | Uint8Array }) {
...
export class BoxesResponse implements Encodable {
   ...
   * next parameter.
   */
  constructor({ applicationId, boxes, nextToken }: { applicationId: number | bigint; boxes: BoxDescriptor[]; nextToken?: string }) {
    this.applicationId = ensureBigInt(applicationId)
    this.boxes = boxes
    this.nextToken = nextToken
  }
  ...
  static fromEncodingData(data: unknown): BoxesResponse {
    ...
    return new BoxesResponse({
      applicationId: data.get('application-id'),
      boxes: (data.get('boxes') ?? []).map((v: unknown) => BoxDescriptor.fromEncodingData(v)),
      nextToken: data.get('next-token'),
    })
  }
}
...
export class ErrorResponse implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['data', typeof this.data !== 'undefined' ? this.data.toEncodingData() : undefined],
    ])
  }
...
export class EvalDelta implements Encodable {
   ...
   */
  constructor({ action, bytes, uint }: { action: number | bigint; bytes?: string; uint?: number | bigint }) {
...
export class HoldingRef implements Encodable {
   ...
   */
  constructor({ address, asset }: { address: Address | string; asset: number | bigint }) {
...
export class IndexerStateProofMessage implements Encodable {
  ...
  constructor({
    ...
    this.blockHeadersCommitment =
      typeof blockHeadersCommitment === 'string' ? base64ToBytes(blockHeadersCommitment) : blockHeadersCommitment
...
export class LocalsRef implements Encodable {
   ...
   * application.
   */
  constructor({ address, app }: { address: Address | string; app: number | bigint }) {
    this.address = typeof address === 'string' ? Address.fromString(address) : address
    this.app = ensureSafeInteger(app)
  }
...
export class MerkleArrayProof implements Encodable {
   ...
   * @param treeDepth - (td)
   */
  constructor({ hashFactory, path, treeDepth }: { hashFactory?: HashFactory; path?: Uint8Array[]; treeDepth?: number | bigint }) {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['hash-factory', typeof this.hashFactory !== 'undefined' ? this.hashFactory.toEncodingData() : undefined],
      ['path', this.path],
...
export class ResourceRef implements Encodable {
  ...
  constructor({
    ...
    this.address = typeof address === 'string' ? Address.fromString(address) : address
    this.applicationId = typeof applicationId === 'undefined' ? undefined : ensureSafeInteger(applicationId)
    this.assetId = typeof assetId === 'undefined' ? undefined : ensureSafeInteger(assetId)
    this.box = box
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['address', typeof this.address !== 'undefined' ? this.address.toString() : undefined],
      ['application-id', this.applicationId],
      ['asset-id', this.assetId],
      ['box', typeof this.box !== 'undefined' ? this.box.toEncodingData() : undefined],
      ['holding', typeof this.holding !== 'undefined' ? this.holding.toEncodingData() : undefined],
      ['local', typeof this.local !== 'undefined' ? this.local.toEncodingData() : undefined],
    ])
  }
...
export class StateProofFields implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['part-proofs', typeof this.partProofs !== 'undefined' ? this.partProofs.toEncodingData() : undefined],
      ['positions-to-reveal', this.positionsToReveal],
      ['reveals', typeof this.reveals !== 'undefined' ? this.reveals.map((v) => v.toEncodingData()) : undefined],
      ['salt-version', this.saltVersion],
      ['sig-commit', this.sigCommit],
      ['sig-proofs', typeof this.sigProofs !== 'undefined' ? this.sigProofs.toEncodingData() : undefined],
    ...
    return new StateProofFields({
      ...
      reveals:
        typeof data.get('reveals') !== 'undefined'
          ? data.get('reveals').map((v: unknown) => StateProofReveal.fromEncodingData(v))
          : undefined,
...
export class StateProofParticipant implements Encodable {
   ...
   * @param weight - (w)
   */
  constructor({ verifier, weight }: { verifier?: StateProofVerifier; weight?: number | bigint }) {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['verifier', typeof this.verifier !== 'undefined' ? this.verifier.toEncodingData() : undefined],
      ['weight', this.weight],
    ])
  }
...
export class StateProofReveal implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['participant', typeof this.participant !== 'undefined' ? this.participant.toEncodingData() : undefined],
      ['position', this.position],
      ['sig-slot', typeof this.sigSlot !== 'undefined' ? this.sigSlot.toEncodingData() : undefined],
    ])
  }
  ...
  static fromEncodingData(data: unknown): StateProofReveal {
    ...
    return new StateProofReveal({
      participant:
        typeof data.get('participant') !== 'undefined' ? StateProofParticipant.fromEncodingData(data.get('participant')) : undefined,
...
export class StateProofSigSlot implements Encodable {
   ...
   * @param signature -
   */
  constructor({ lowerSigWeight, signature }: { lowerSigWeight?: number | bigint; signature?: StateProofSignature }) {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['signature', typeof this.signature !== 'undefined' ? this.signature.toEncodingData() : undefined],
    ])
  }
...
export class StateProofSignature implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['proof', typeof this.proof !== 'undefined' ? this.proof.toEncodingData() : undefined],
...
export class StateProofVerifier implements Encodable {
   ...
   */
  constructor({ commitment, keyLifetime }: { commitment?: string | Uint8Array; keyLifetime?: number | bigint }) {
...
export class TealValue implements Encodable {
   ...
   */
  constructor({ bytes, type, uint }: { bytes: string | Uint8Array; type: number | bigint; uint: number | bigint }) {
...
export class Transaction implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['group', this.group],
      ['heartbeat-transaction', typeof this.heartbeatTransaction !== 'undefined' ? this.heartbeatTransaction.toEncodingData() : undefined],
      ['id', this.id],
      ['inner-txns', typeof this.innerTxns !== 'undefined' ? this.innerTxns.map((v) => v.toEncodingData()) : undefined],
      ['intra-round-offset', this.intraRoundOffset],
      ['keyreg-transaction', typeof this.keyregTransaction !== 'undefined' ? this.keyregTransaction.toEncodingData() : undefined],
      ['lease', this.lease],
      ['local-state-delta', typeof this.localStateDelta !== 'undefined' ? this.localStateDelta.map((v) => v.toEncodingData()) : undefined],
      ['logs', this.logs],
      ['note', this.note],
      ['payment-transaction', typeof this.paymentTransaction !== 'undefined' ? this.paymentTransaction.toEncodingData() : undefined],
      ['receiver-rewards', this.receiverRewards],
      ['rekey-to', typeof this.rekeyTo !== 'undefined' ? this.rekeyTo.toString() : undefined],
    ...
    return new Transaction({
      ...
      globalStateDelta:
        typeof data.get('global-state-delta') !== 'undefined'
          ? data.get('global-state-delta').map((v: unknown) => EvalDeltaKeyValue.fromEncodingData(v))
          : undefined,
      ...
      innerTxns:
        typeof data.get('inner-txns') !== 'undefined'
          ? data.get('inner-txns').map((v: unknown) => Transaction.fromEncodingData(v))
          : undefined,
      ...
      localStateDelta:
        typeof data.get('local-state-delta') !== 'undefined'
          ? data.get('local-state-delta').map((v: unknown) => AccountStateDelta.fromEncodingData(v))
          : undefined,
      logs: data.get('logs'),
      note: data.get('note'),
      paymentTransaction:
...
export class TransactionApplication implements Encodable {
  ...
  constructor({
    ...
    this.access = access
    this.accounts =
      typeof accounts !== 'undefined' ? accounts.map((addr) => (typeof addr === 'string' ? Address.fromString(addr) : addr)) : undefined
    ...
    this.rejectVersion = typeof rejectVersion === 'undefined' ? undefined : ensureSafeInteger(rejectVersion)
  }
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['application-id', this.applicationId],
      ['access', typeof this.access !== 'undefined' ? this.access.map((v) => v.toEncodingData()) : undefined],
      ['accounts', typeof this.accounts !== 'undefined' ? this.accounts.map((v) => v.toString()) : undefined],
      ['application-args', this.applicationArgs],
      ['approval-program', this.approvalProgram],
      ['box-references', typeof this.boxReferences !== 'undefined' ? this.boxReferences.map((v) => v.toEncodingData()) : undefined],
      ['clear-state-program', this.clearStateProgram],
      ['extra-program-pages', this.extraProgramPages],
  ...
  static fromEncodingData(data: unknown): TransactionApplication {
    ...
    return new TransactionApplication({
      applicationId: data.get('application-id'),
      access:
        typeof data.get('access') !== 'undefined' ? data.get('access').map((v: unknown) => ResourceRef.fromEncodingData(v)) : undefined,
      accounts: data.get('accounts'),
      applicationArgs: data.get('application-args'),
      approvalProgram: data.get('approval-program'),
      boxReferences:
        typeof data.get('box-references') !== 'undefined'
          ? data.get('box-references').map((v: unknown) => BoxReference.fromEncodingData(v))
          : undefined,
      clearStateProgram: data.get('clear-state-program'),
      extraProgramPages: data.get('extra-program-pages'),
      ...
      globalStateSchema:
        typeof data.get('global-state-schema') !== 'undefined' ? StateSchema.fromEncodingData(data.get('global-state-schema')) : undefined,
      localStateSchema:
        typeof data.get('local-state-schema') !== 'undefined' ? StateSchema.fromEncodingData(data.get('local-state-schema')) : undefined,
...
export class TransactionAssetConfig implements Encodable {
   ...
   * data/transactions/asset.go : AssetParams
   */
  constructor({ assetId, params }: { assetId?: number | bigint; params?: AssetParams }) {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['asset-id', this.assetId],
      ['params', typeof this.params !== 'undefined' ? this.params.toEncodingData() : undefined],
    ])
  }
...
export class TransactionAssetFreeze implements Encodable {
   ...
   */
  constructor({ address, assetId, newFreezeStatus }: { address: string; assetId: number | bigint; newFreezeStatus: boolean }) {
    this.address = address
    this.assetId = ensureBigInt(assetId)
...
export class TransactionResponse implements Encodable {
   ...
   * data/transactions/transaction.go : Transaction
   */
  constructor({ currentRound, transaction }: { currentRound: number | bigint; transaction: Transaction }) {
    this.currentRound = ensureBigInt(currentRound)
...
export class TransactionSignature implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['logicsig', typeof this.logicsig !== 'undefined' ? this.logicsig.toEncodingData() : undefined],
      ['multisig', typeof this.multisig !== 'undefined' ? this.multisig.toEncodingData() : undefined],
      ['sig', this.sig],
    ])
  }
  ...
  static fromEncodingData(data: unknown): TransactionSignature {
    ...
    return new TransactionSignature({
      logicsig:
        typeof data.get('logicsig') !== 'undefined' ? TransactionSignatureLogicsig.fromEncodingData(data.get('logicsig')) : undefined,
      multisig:
        typeof data.get('multisig') !== 'undefined' ? TransactionSignatureMultisig.fromEncodingData(data.get('multisig')) : undefined,
      sig: data.get('sig'),
    })
  }
}
...
export class TransactionSignatureLogicsig implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['multisig-signature', typeof this.multisigSignature !== 'undefined' ? this.multisigSignature.toEncodingData() : undefined],
...
export class TransactionSignatureMultisig implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['subsignature', typeof this.subsignature !== 'undefined' ? this.subsignature.map((v) => v.toEncodingData()) : undefined],
    ...
    return new TransactionSignatureMultisig({
      subsignature:
        typeof data.get('subsignature') !== 'undefined'
          ? data.get('subsignature').map((v: unknown) => TransactionSignatureMultisigSubsignature.fromEncodingData(v))
          : undefined,
...
export class TransactionSignatureMultisigSubsignature implements Encodable {
   ...
   * @param signature - (s)
   */
  constructor({ publicKey, signature }: { publicKey?: string | Uint8Array; signature?: string | Uint8Array }) {
...
export class TransactionStateProof implements Encodable {
  ...
  toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ['message', typeof this.message !== 'undefined' ? this.message.toEncodingData() : undefined],
      ['state-proof', typeof this.stateProof !== 'undefined' ? this.stateProof.toEncodingData() : undefined],
...
export class TransactionsResponse implements Encodable {
  ...
  static fromEncodingData(data: unknown): TransactionsResponse {
    ...
    return new TransactionsResponse({
      currentRound: data.get('current-round'),
      transactions: (data.get('transactions') ?? []).map((v: unknown) => Transaction.fromEncodingData(v)),
      nextToken: data.get('next-token'),
    })
  }
}
