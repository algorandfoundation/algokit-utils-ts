...
export type TokenHeaderIdentifier = 'X-Indexer-API-Token' | 'X-KMD-API-Token' | 'X-Algo-API-Token' | string
 ...
 */
function convertTokenStringToTokenHeader(headerIdentifier: TokenHeaderIdentifier, token: string = ''): TokenHeader {
...
function isBaseHTTPClient(tbc: string | TokenHeader | BaseHTTPClient): tbc is BaseHTTPClient {
