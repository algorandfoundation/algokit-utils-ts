  ...
  fields: [
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionApplicationMeta),
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionAssetConfigMeta),
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionAssetFreezeMeta),
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionAssetTransferMeta),
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionStateProofMeta),
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionHeartbeatMeta),
    },
    {
      name: 'authAddr',
      wireKey: 'auth-addr',
    ...
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionKeyregMeta),
    },
    {
      name: 'lastValid',
      wireKey: 'last-valid',
    ...
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionPaymentMeta),
    },
    {
    ...
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(TransactionSignatureMeta),
    },
    {
      name: 'txType',
      wireKey: 'tx-type',
