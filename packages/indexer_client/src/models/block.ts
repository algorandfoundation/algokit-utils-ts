...
export const BlockMeta: ObjectModelMetadata = {
  ...
  fields: [
    ...
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(BlockRewardsMeta),
    },
    {
      name: 'round',
      wireKey: 'round',
    ...
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ArrayCodec(new ModelCodec(StateProofTrackingMeta)),
    },
    {
      name: 'timestamp',
      wireKey: 'timestamp',
    ...
    },
    {
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(BlockUpgradeStateMeta),
    },
    {
      name: 'upgradeVote',
      ...
      optional: true,
      nullable: false,
      codec: new ModelCodec(BlockUpgradeVoteMeta),
    },
    {
