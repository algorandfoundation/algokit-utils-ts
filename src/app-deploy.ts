...
/**
 * @deprecated Use `appDeployer.deploy` instead.
 *
...
/**
 * @deprecated Use `appDeployer.getCreatorApps` instead.
 *
...
export async function getCreatorAppsByName(creatorAccount: SendTransactionFrom | string, indexer: Indexer): Promise<AppLookup> {
  const lookup = await new AppDeployer(undefined!, undefined!, indexer).getCreatorApps(getSenderAddress(creatorAccount))
...
/**
 * @deprecated Use `appManager.compileTealTemplate` instead.
 *
