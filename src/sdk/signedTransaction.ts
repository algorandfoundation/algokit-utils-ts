...
import { Encodable, decodeMsgpack, encodeMsgpack } from './encoding/encoding.js'
import { AddressSchema, FixedLengthByteArraySchema, NamedMapSchema, OptionalSchema, allOmitEmpty } from './encoding/schema/index.js'
...
export class SignedTransaction implements Encodable {
  ...
  public toEncodingData(): Map<string, unknown> {
    return new Map<string, unknown>([
      ...
      ['sig', this.sig],
      ['msig', this.msig ? encodedMultiSigToEncodingData(this.msig) : undefined],
