...
describe('amount', () => {
  ...
  test('microalgos to microalgos', () => {
    expect(microAlgos(100).microAlgo).toBe(100)
  })
  test('algos to microalgos', () => {
    expect(algos(100).microAlgo).toBe(100_000_000)
  })
  test('algos to algos', () => {
  ...
  test('single transaction fee', () => {
    expect(transactionFees(1).microAlgo).toBe(1_000)
  })
  test('multiple transaction fees', () => {
    expect(transactionFees(10).microAlgo).toBe(10_000)
  })
  ...
  test('microAlgos via Number.prototype', () => {
    ...
    expect((100).microAlgo().microAlgo).toBe(100)
  })
})
