...
import { ABIArgumentType, ABIMethod, ABIReturnType } from './abi-method'
import { decodeABIValue, encodeABIValue, stringToABIType } from './abi-type'
...
/**
 * Wrapper around `ABIMethod` that represents an ARC-56 ABI method.
 */
export type Arc56Method = ABIMethod & {
  args: Array<Arc56MethodArg>
  returns: Arc56MethodReturnType
}
 ...
 */
export function getArc56ReturnValue<TReturn extends Uint8Array | ABIValue | ABIStruct | undefined>(
...
export interface Arc56Contract {
  ...
  templateVariables?: {
    [name: string]: {
      ...
      type: ABITypeFoo | AVMType | StructName
...
/** An ABI-encoded type */
export type ABITypeFoo = string // TODO: find a better name
...
export interface StructField {
  ...
  type: ABITypeFoo | StructName | StructField[]
}
...
export interface StorageKey {
  ...
  desc?: string
  /** The type of the key */
  keyType: ABITypeFoo | AVMType | StructName

  /** The type of the value */
  valueType: ABITypeFoo | AVMType | StructName
